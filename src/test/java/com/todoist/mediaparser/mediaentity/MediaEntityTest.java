...
public class MediaEntityTest {
    ...
    public void testImageFileParser() throws IOException {
        ...
        mediaEntity =
                MediaParser.getInstance(
                        "http://upload.wikimedia.org/wikipedia/commons/thumb/0/01/Sego_lily_cm.jpg/225px-Sego_lily_cm.jpg");
        mediaEntity.configure(null);
    ...
    public void testHuluParser() throws IOException {
        ...
        mediaEntity =
                MediaParser.getInstance("http://hulu.com/watch/20807/late-night-with-conan-obrien-wed-may-21-2008");
        mediaEntity.configure(null);
        checkThumbnailAndUrlContentType(mediaEntity, HuluEntity.class, 666);
    }
    ...
    public void testSlideShareParser() throws IOException {
        ...
        mediaEntity =
                MediaParser.getInstance(
                        "http://www.slideshare.net/intelleto/leading-lean-managing-lean-ux-work-in-the-enterprise-mx-2014-conference-by-adaptive-path");
        mediaEntity.configure(null);
